const I18N = {
  en: {
    ...
    "projects.p2.b2": "My part: sensor wiring and reading, sending signals to the server, and the relay control API.",
  ...
  vi: {
    ...
    "projects.p2.b2": "Phần của mình: đi dây và đọc cảm biến, gửi tín hiệu lên server, và API điều khiển relay.",
