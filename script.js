const I18N = {
  en: {
    ...
    "projects.p3.b3": "I built the sensing and firmware parts; AI drowsiness detection belonged to teammates — the work was accepted as a co-authored paper at CUTE 2026 (see Publications).",
    "pubs.title": "Publications",
    "pubs.published": "Published",
    "pubs.accepted": "Accepted",
    "pubs.submitted": "Submitted",
    "pubs.role": "Co-author",
    "pubs.role.first": "First author",
    "awards.title": "Awards",
    "edu.title": "Education",
  ...
  vi: {
    ...
    "about.p1": "Sinh viên năm cuối ngành Kỹ thuật vi mạch tại HUFLIT, tập trung vào hệ thống nhúng và IoT — từ firmware bare-metal tới bring-up bo mạch và kiểm chứng đo đạc. Tác giả 4 bài báo hội nghị quốc tế (1 bài đã công bố và 2 bài được chấp nhận với vai trò đồng tác giả, 1 bài đã nộp với vai trò tác giả chính). Đang tìm vị trí thực tập hệ thống nhúng để đóng góp vào sản phẩm phần cứng thực tế và phát triển lên kỹ sư nhúng full-time.",
    ...
    "projects.p3.b3": "Mình làm phần cảm biến và firmware; phần AI phát hiện ngủ gục do team phụ trách — nghiên cứu đã được chấp nhận là bài báo đồng tác giả tại CUTE 2026 (xem Bài báo khoa học).",
