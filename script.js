const I18N = {
  ...
  vi: {
    ...
    "about.p1": "Sinh viên năm cuối ngành Kỹ thuật vi mạch tại HUFLIT, tập trung vào hệ thống nhúng và IoT — từ firmware bare-metal tới bring-up bo mạch và kiểm chứng đo đạc. Tác giả 4 bài báo hội nghị quốc tế (2 bài đã công bố và 1 bài được chấp nhận với vai trò đồng tác giả, 1 bài đã nộp với vai trò tác giả chính). Đang tìm vị trí thực tập hệ thống nhúng để đóng góp vào sản phẩm phần cứng thực tế và phát triển lên kỹ sư nhúng full-time.",
