const I18N = {
  en: {
    ...
    "hero.cv": "Download CV",
    "about.title": "About",
    "about.p1": "Final-year Microelectronics Engineering student at HUFLIT focused on embedded systems and IoT — from bare-metal firmware to board bring-up and validation.",
    "objective.title": "Objective",
    "objective.body": "Seeking an embedded systems internship where I can contribute to real hardware and grow toward a full-time embedded firmware engineer for low-power IoT and edge-AI devices.",
  ...
  vi: {
    ...
    "about.p1": "Sinh viên năm cuối ngành Kỹ thuật vi mạch tại HUFLIT, tập trung vào hệ thống nhúng và IoT — từ firmware bare-metal tới bring-up bo mạch và kiểm chứng đo đạc.",
    "objective.title": "Mục tiêu",
    "objective.body": "Tìm vị trí thực tập hệ thống nhúng để đóng góp vào sản phẩm phần cứng thực tế và phát triển lên kỹ sư firmware nhúng full-time cho thiết bị IoT tiết kiệm năng lượng và edge-AI.",
